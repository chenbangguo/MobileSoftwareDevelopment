...
fun main() {
    ...
    val event1 = Event("Study Kotlin", "Commit to studying Kotlin", Daypart.MORNING, 30)
    val event2 = Event("Study Android", "Practice Compose", Daypart.AFTERNOON, 45)
    val event3 = Event("Exercise", "Running", Daypart.EVENING, 60)
    val event4 = Event("Reading", "Read book", Daypart.MORNING, 20)
    val event5 = Event("Cooking", "Make dinner", Daypart.EVENING, 50)
    val event6 = Event("Cleaning", "Clean room", Daypart.AFTERNOON, 30)
...
fun main() {
    ...
    println("Last event: ${lastEvent.title}")
}
```
...
// 使用：
fun main() {
    val event = Event("Test", null, Daypart.MORNING, 50)
    println(event.durationOfEvent) // 输出 short
}
```
